...
class PideProductionDataSeeder extends Seeder
{
    ...
    {
        // Render puede ejecutar el seeder en cada arranque. Si la demo ya
        // contiene usuarios, conservamos todos los cambios realizados.
        ...
        $this->insertWithId('usuarios', array_map(fn ($r) => [
            ...
            'password_hash' => $r['USU_username'] === 'admin'
                ? Hash::make((string) env('DEMO_ADMIN_PASSWORD', 'DemoSCPIDE2026!'))
                : $r['USU_password_hash'],
            'email' => $r['USU_email'],
            'requiere_cambio_password' => $r['USU_username'] === 'admin'
                ? false
                : (bool) $r['USU_requiere_cambio_password'],
