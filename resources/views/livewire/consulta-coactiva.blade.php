<div class="modulo-legacy consulta-legacy page" style="--source:#0f766e">
    <section class="page-title consulta-page-title">
        <span class="consulta-source-logo"><img src="{{ asset('assets/images/sunat-logo-sin-fondo.png') }}" alt="SUNAT"></span>
        <div>
    ...
    <x-consulta-print-header
        entity-logo="sunat-logo-sin-fondo.png"
        entity="SUNAT"
        title="Cobranza Coactiva - SUNAT"
    ...
    <section class="consulta-legacy-results" aria-live="polite" aria-busy="{{ $searched && !$real ? 'true' : 'false' }}">
        <article class="content-wrapper consulta-info-card coactiva-detail-card">
            ...
            @if($searched && $real && $totalDeudas > 0)
